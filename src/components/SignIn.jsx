...
function SignIn() {
  ...
  return (
    ...
    >
      <img
        style={{ width: '340px', height: '360px', marginBottom: '10px' }}
        src="https://prepinsta.com/wp-content/uploads/2021/02/4eb3ac71b41d4fe11f0b2ad81bf63fd81.webp"
        alt="Chat Logo"
      />
      <Button
        style={{
      ...
      >
        <img
          style={{ padding: '3px', marginTop: '1px', marginRight: '5px' }}
